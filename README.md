...
# Ebuy API
A backend application with graphql API for ebuy frontend. Super fast api build with nodejs, graphql and express.js. It is specially designed for any e-commerce web applications.
